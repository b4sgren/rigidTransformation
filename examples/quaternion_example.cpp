...
//         // res = info_ * rt::Quaternion<T>::Log(R.inverse() * R_);
//         return true;
//     }
...
//         // rt::Quaternion<T> R(rot), Rpd(R_plus_delta);
...
int main(int argc, char *argv[]) {
    ...
    // }
    // rt::Quaternion<double> R_hat = measurements[0];
    ...
    //         ceres::AutoDiffLocalParameterization<Quaternion_Parameterization, 9, 3>();
